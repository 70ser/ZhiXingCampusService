...
public class MatchController {
    ...
    //通过自习id号来匹配：寻找学伴
    @GetMapping("/get")
    public Result matchpeople(@RequestParam Integer id,@RequestParam Integer pageNum,
        ...
        wrapper.between("address",time.getAddress(),"无");
        ...
        if(list.size()==0){//通过list的长度判断结果
            ...
            return Result.success(timeService.page(new Page<>(pageNum, pageSize), wrapper));
        }
    }
